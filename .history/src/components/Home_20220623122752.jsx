...
const Home = () => {
    ...
    const sendTokenHandler=async (e)=>{
      ...
      let adapterParam="0x"
      let sendTokenTransaction= await xapContract.sendTokens( dstChainId, to, qty,zeroPaymentAddress, adapterParam,{gasLimit: 1000784, gasPrice: ethers.utils.parseUnits("1.5", "gwei")} )
