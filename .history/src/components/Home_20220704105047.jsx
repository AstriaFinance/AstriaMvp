    ...
    <div className="bg-gray-900 h-screen overflow-y-auto">
      ...
      <div className="bg-gray-600 rounded-xl h-1/2 mx-3 my-3 p-3 ">
        ...
        <div className="flex  overflow-x-auto text-center">
          <div className=" bg-gradient-to-r from-green-400 to-blue-500 rounded-md h-10  items-center    mx-3">
            ETHEREUM
          </div>
          <div className="bg-gradient-to-r from-green-400 to-blue-500 rounded-md   mx-3">
            BINANCE SMARTCHAIN
          </div>
          <div className="bg-gradient-to-r from-green-400 to-blue-500 rounded-md  mx-3">
            FANTOM
