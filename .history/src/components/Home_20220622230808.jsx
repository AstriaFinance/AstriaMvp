...
const Home = () => {
    ...
    const testEthContractAddress="0xFEccDB1aCe7f5ad29BE0aB7Cf9BC67ebF81bd780"
...
<form onSubmit={mintHandler}>
 <div className="bg-white h-72 w-64 rounded my-32 mx-7">
  ...
  <div className="flex justify-between">
   ...
   <ul className="mx-5 my-3 flex gap-6">
     ...
     if(setConButtonText ("Wallet connected")){
     <li>{defaultAccount.slice(0,5)}...{defaultAccount.slice(defaultAccount.length-4)}</li>}
   </ul>
 </div>
 </form>
 ...
 <div className="bg-white h-72 w-64 rounded mx-5 my-32">
  ...
  <div className="flex justify-between">
    <form onSubmit={approveTestEth}>
  <button className="bg-blue-500 rounded mx-5 w-20 ">connect</button></form>
