...
const Home = () => {
  ...
  return (
    <div className="bg-gray-900 h-screen overflow-y-auto">
      ...
      <div className="bg-gray-600 rounded-xl h-1/2 mx-3 my-3 p-3 ">
        <h2 className="text-white font-bold ">Choose Chain</h2>
        <div className="flex  overflow-x-auto text-center">
      ...
      <div className="bg-gray-600 rounded-xl h-1/2 mx-3 my-5 p-3 ">
        ...
        <div>
          ...
          <div className="bg-gray-500 p-3 rounded-md">
            <form action="">
              <div className="text-white font-thin">Traverse Chains BSC </div>
              <input
                type="number"
                placeholder="0.0"
                className="w-full bg-gray-500 "
      ...
      <p className="text-red-500">
        Hint: in this mvp vesrsion, you can only connect to Ethereum rinkeby to
        mint testColleteral token, deposit your colleteral and borrow. borrowed
        TAUSD can be transfered to BSC testnet. all 7 chains will be supported
        on mainet launch and the transfer will be abstracted so that u can
        borrow and transfer to chain of ur choice in a single click{" "}
      </p>
    </div>
  );
};
