  ...
  return (
    <div className="bg-gray-900 h-screen">
      ...
      <div className="bg-gray-600 rounded-xl h-1/2 mx-3 p-3">
        ...
        <div className="flex overflow-y-auto mx-3">
          <div className="bg-gray-300 rounded-md w-20 text-center">ETH</div>
          <div className="bg-gray-300 rounded-md w-20 text-center">BSC</div>
          <div className="bg-gray-300 rounded-md w-20 text-center">FTM</div>
          <div className="bg-gray-300 rounded-md w-20 text-center">AVAX</div>
          <div className="bg-gray-300 rounded-md w-20 text-center">AETH</div>
          <div className="bg-gray-300 rounded-md w-20 text-center">MATIC</div>
          <div className="bg-gray-300 rounded-md w-20 text-center">OPT</div>
        </div>
      </div>
    </div>
  );
