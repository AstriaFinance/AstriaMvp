  ...
  return (
    <div>
      <div className="flex bg-black">
        <div className="rounded bg-white mr-2">
          <div className="mx-2">TestCollteral</div>
          <div className="mx-2">TestCollteral</div>
        </div>
        <div className="rounded bg-white w-20 m2-2">TestCollteral</div>
        <div className="rounded bg-white w-64 ml-5 ">
          <div className="text-sm truncate hover:text-clip">
            {defaultAccount}
          </div>
        </div>
      </div>
