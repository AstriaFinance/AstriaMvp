...
const Home = () => {
  return (
    ...
    <div className=' flex items-center justify-center h-64 w-64 rounded-xl mx-80 bg-blue-900 mt-20 shadow-xl'>
    ...
    <div className=' items-center justify-center h-64 w-64 rounded-xl mx-80 bg-blue-900 mt-20 shadow-xl'>
        <div className='mx-3'>DEPOSIT</div>
        <input type="text" className='rounded hover:bg-purple-900' />
        <div className='mx-3'>Borrow</div>
        <input type="text" className='rounded hover:bg-purple-900' />
